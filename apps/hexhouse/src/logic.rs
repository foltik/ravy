...
// use lib::lights::layout::Hexhouse as Lights;
...
impl BeamPattern {
    fn apply(self, s: &mut State, pd: Pd, beam: &mut StealthBeam, i: usize, fr: f32) {
